Public Class GameForm
    ...
    Private Const MarginSize As Integer = 10 '卡片之间的间距
    ...
    Private Sub DrawForm()
        ...
        Dim UnityBitmap As Bitmap = My.Resources._2048Resource.Background
        Using UnityGraphics As Graphics = Graphics.FromImage(UnityBitmap)
            For IndexY As Integer = 0 To 3
                For IndexX As Integer = 0 To 3
                    UnityGraphics.DrawImage(My.Resources._2048Resource.ResourceManager.GetObject("Card" & CardData(IndexY, IndexX)), PaddingSize + IndexX * 70, PaddingSize + IndexY * 74 + TitleHeight, 70, 74)
                Next
            Next
        End Using
